...
public class Kef_4Script : MonoBehaviour {
    ...
    string[] Questions = { 
        ...
        ,"Ποιες περιοχές θεωρεί ο Βρετανός πολιτικός στην Πηγή 3 πως θα έπρεπε να ανήκουν στο ελληνικό κρά τος; " +
            "Βρίσκετε ομοιότητες στις απόψεις του με τις θέσεις που εκφράζει ο Τρικούπης στην Πηγή 1;"
        ,"Ερώτηση 3η"
    ...
    public async void PressedAnswer(int choice) {
        ...
        if (!LoadQnA()) {
            ...
            TableQuestion.text = "Τέλος 4ης Ενότητας."
    ...
    private void ShowHidePanel(string ComeOrBye) {
        ...
        if (ComeOrBye == "Welcome") {
            TitlePanel.text = "Καλωσήρθες στην 4η Ενότητα του παιχνιδού μας";
            switchWelcomeGoodByePanel(true);
        }
        else if (ComeOrBye == "GoodBye") {
            TitlePanel.text = "Ολοκλήρωσες την 4η Ενότητα του παιχνιδού μας";
